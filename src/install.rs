...
pub fn json_plan() -> Result<serde_json::Value> {
    ...
    Ok(
        serde_json::json!({"changed":integration_changed || startup_changed,"integration":{"path":crate::protocol::BytePath::path(&integration_path),"would_change":integration_changed},"startup":{"path":crate::protocol::BytePath::path(&zshrc_path),"would_change":startup_changed}}),
    )
}
